...
const obsidian = {
  ...
  getManagedPresenceState: getManagedNotePresenceState,
  getManagedSourceHash: getManagedObsidianSourceHash,
  repairManagedLinks: repairObsidianManagedLinks,
  restoreManagedNotes: restoreManagedObsidianNotes,
  rebindManagedNotes: rebindManagedObsidianNotes,
  unlinkManagedNotes: unlinkManagedObsidianNotes,
  ...
  resolveManagedPath: resolveManagedNotePath,
