...
exports.InboundCreator = void 0;
const package_json_1 = require("../../../package.json");
const base_1 = require("../base");
const prefs_1 = require("../../utils/prefs");
class InboundCreator extends base_1.PluginCEBase {
    constructor() {
        super(...arguments);
        this._openedNoteIDs = [];
        this.loaded = false;
...
<linkset>
  <html:link
    rel="stylesheet"
    href="chrome://${package_json_1.config.addonRef}/content/styles/linkCreator/inboundCreator.css"
  ></html:link>
</linkset>
...
`);
    ...
    loadNotePicker() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            content.dataset.l10nId = `${package_json_1.config.addonRef}-inbound-step1-content`;
    ...
    loadNoteOutline() {
        ...
        const content = document.createElement("span");
        content.dataset.l10nId = `${package_json_1.config.addonRef}-inbound-step2-content`;
        content.classList.add("toolbar-header", "content");
        const title = document.createElement("span");
    ...
    loadNotePreview() {
        ...
        const content = document.createElement("span");
        content.dataset.l10nId = `${package_json_1.config.addonRef}-inbound-step3-content`;
        content.classList.add("toolbar-header", "content");
        ...
        middleTitle.dataset.l10nId = `${package_json_1.config.addonRef}-inbound-step3-middle`;
    ...
    updatePreviewTitle() {
        ...
        this.querySelector("#preview-note-from-title").textContent =
            ((_a = this.targetNote) === null || _a === void 0 ? void 0 : _a.getNoteTitle()) || "No title";
        ...
        this.querySelector("#preview-note-to-title").textContent =
            ((_b = this.currentNote) === null || _b === void 0 ? void 0 : _b.getNoteTitle()) || "No title";
    }
    updateNotePreview() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.loaded || !this.targetNote)
                return;
            const lines = yield this._addon.api.note.getLinesInNote(this.targetNote, {
                convertToHTML: true,
            });
    ...
    getContentToInsert() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.currentNote || !this.targetNote)
                return "";
            return yield this._addon.api.template.runQuickInsertTemplate(this.currentNote, this.targetNote, { dryRun: true });
        });
    }
    getIndexToInsert() {
...
exports.InboundCreator = InboundCreator;
