...
`);
  ...
  async loadNotePicker() {
    this.notePicker = this.querySelector("zob-note-picker") as NotePicker;
  ...
  loadNoteOutline() {
    this.noteOutline = this.querySelector("zob-note-outline") as OutlinePicker;
  ...
  loadNotePreview() {
    this.notePreview = this.querySelector("zob-note-preview") as NotePreview;
